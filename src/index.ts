...
const TEMPLATES = FRAMEWORKS.map(
  (framework) =>
    (framework.variants && framework.variants.map((value) => value.name)) || [
      framework.name,
    ]
    ...
    result = await prompts(
      [
        ...
        },
        {
          ...
          validate: (value) =>
            isValidPackageName(value) || "Invalid package.json name",
        },
        {
          type: () =>
          ...
          message:
            typeof argTemplate === "string" && !TEMPLATES.includes(argTemplate)
              ? reset(
                  `Invalid template: ${argTemplate}. Please choose from below:`
                )
        ...
        },
        {
          name: "glasscockpitID",
          type: "text",
          message: reset("Glasscockpit ID:"),
          initial: () => getProjectName(),
          validate: (value) =>
            isValidGlasscockpitID(value) || "Invalid Glasscockpit ID",
        },
      ],
      {
        onCancel: () => {
